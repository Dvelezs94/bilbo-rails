...
class CampaignTest < ActiveSupport::TestCase
  ...
  test "campaign with steps" do
    @board_steps = create(:board, project: @user.projects.first, name: "STEPS", lat: "25.66508", lng: "-100.33103", avg_daily_views: "-100.33103", width: "1280", height: "720",
      ...
      assert_equal @board_steps.no_smart_prices[4][1], @campaign.budget
  end
  test "campaign with steps and multiplier" do
    @board_steps = create(:board, project: @user.projects.first, name: "STEPS", lat: "25.66508", lng: "-100.33103", avg_daily_views: "-100.33103", width: "1280", height: "720",
      ...
      assert_equal @board_steps.no_smart_prices[0][1],@campaign.budget
      assert_equal @board_steps.no_smart_prices.size, @board_steps.multiplier
  end
end
