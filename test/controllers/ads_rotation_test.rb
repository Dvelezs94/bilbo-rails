...
class AdsRotationTest < ActionDispatch::IntegrationTest
  ...
  test "Budget campaigns low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 100)
    campaign_2 = create(:campaign, name: "2 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, budget: 200)
    campaign_3 = create(:campaign, name: "3 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, budget: 300)
  ...
  test "Budget campaigns moderated occupation" do
    #~50% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 200)
    campaign_2 = create(:campaign, name: "2 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, budget: 400)
    campaign_3 = create(:campaign, name: "3 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, budget: 600)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Budget campaigns high occupation" do
    #~95% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 400)
    campaign_2 = create(:campaign, name: "2 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, budget: 700)
    campaign_3 = create(:campaign, name: "3 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, budget: 1200)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute low occupation" do
    #25% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 1, minutes: 2)
    campaign_2 = create(:campaign, name: "2 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, imp: 1, minutes: 4)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, imp: 1, minutes: 6)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute moderated occupation" do
    #50% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 2, minutes: 2)
    campaign_2 = create(:campaign, name: "2 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, imp: 2, minutes: 4)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, imp: 2, minutes: 6)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute high occupation" do
    #100% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 3, minutes: 1)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0, imp: 1, minutes: 1)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
    ads = JSON.parse(@board.ads_rotation)
  ...
  test "Campaigns per hour low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0)
  ...
  test "Campaigns per hour moderated occupation" do
    ...
    campaign_1 = create(:campaign, name: "1 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
  ...
  test "Multiple types low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 250)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0)
  ...
  test "Multiple types moderated occupation" do
    ...
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_30.id, state: true, status: 0)
    campaign_4 = create(:campaign, name: "4 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 300)
  ...
  test "Multiple types high occupation" do
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 350)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
    campaign_4 = create(:campaign, name: "4 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 400)
    campaign_5 = create(:campaign, name: "5 Per minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 1, minutes: 1)
    campaign_6 = create(:campaign, name: "6 Per minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 2, minutes: 1)
  ...
  #   campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 5000)
  ...
  test "No more space for minute campaigns" do
    campaign_1 = create(:campaign, name: "1 Per Hour", project: @project, classification: 2, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0)
    campaign_2 = create(:campaign, name: "2 Per Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 3, minutes: 1)
    campaign_1.impression_hours.create(start: "2000-01-01 18:00:00", end: "2000-01-01 19:00:00", imp: 200, day: "everyday")
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Budget campaigns do not fit" do
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, budget: 800)
    campaign_2 = create(:campaign, name: "2 Per Minute", project: @project, classification: 1, provider_campaign: true, ad_id: @ad_10.id, state: true, status: 0, imp: 5, minutes: 1)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "First day test" do
    ...
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, ad_id: @ad_20.id, state: true, status: 0, budget: 700)
    campaign_1.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
