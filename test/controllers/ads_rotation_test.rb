...
class AdsRotationTest < ActionDispatch::IntegrationTest
  ...
  test "Budget campaigns low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 100)
    campaign_2 = create(:campaign, name: "2 Budget", project: @project, classification: 0, provider_campaign: true, duration: 20, state: true, status: 0, budget: 200)
    campaign_3 = create(:campaign, name: "3 Budget", project: @project, classification: 0, provider_campaign: true, duration: 30, state: true, status: 0, budget: 300)
  ...
  test "Budget campaigns moderated occupation" do
    #~50% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 200)
    campaign_2 = create(:campaign, name: "2 Budget", project: @project, classification: 0, provider_campaign: true, duration: 20, state: true, status: 0, budget: 400)
    campaign_3 = create(:campaign, name: "3 Budget", project: @project, classification: 0, provider_campaign: true, duration: 30, state: true, status: 0, budget: 600)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute low occupation" do
    #25% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, duration: 10, state: true, status: 0, imp: 1, minutes: 2)
    campaign_2 = create(:campaign, name: "2 Minute", project: @project, classification: 1, provider_campaign: true, duration: 20, state: true, status: 0, imp: 1, minutes: 4)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, duration: 30, state: true, status: 0, imp: 1, minutes: 6)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute moderated occupation" do
    #50% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, duration: 10, state: true, status: 0, imp: 2, minutes: 2)
    campaign_2 = create(:campaign, name: "2 Minute", project: @project, classification: 1, provider_campaign: true, duration: 20, state: true, status: 0, imp: 2, minutes: 4)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, duration: 30, state: true, status: 0, imp: 2, minutes: 6)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Campaigns per minute high occupation" do
    #100% use
    campaign_1 = create(:campaign, name: "1 Minute", project: @project, classification: 1, provider_campaign: true, duration: 10, state: true, status: 0, imp: 3, minutes: 1)
    campaign_3 = create(:campaign, name: "3 Minute", project: @project, classification: 1, provider_campaign: true, duration: 30, state: true, status: 0, imp: 1, minutes: 1)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_3.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
    ads = JSON.parse(@board.ads_rotation)
  ...
  test "Campaigns per hour low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 10, state: true, status: 0)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 20, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 30, state: true, status: 0)
  ...
  test "Multiple types low occupation" do
    #~25% use
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 250)
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 20, state: true, status: 0)
  ...
  test "Multiple types moderated occupation" do
    ...
    campaign_2 = create(:campaign, name: "2 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 20, state: true, status: 0)
    campaign_3 = create(:campaign, name: "3 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 30, state: true, status: 0)
    campaign_4 = create(:campaign, name: "4 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 300)
  ...
  #   campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 5000)
  ...
  test "No more space for minute campaigns" do
    campaign_1 = create(:campaign, name: "1 Per Hour", project: @project, classification: 2, provider_campaign: true, duration: 10, state: true, status: 0)
    campaign_2 = create(:campaign, name: "2 Per Minute", project: @project, classification: 1, provider_campaign: true, duration: 10, state: true, status: 0, imp: 3, minutes: 1)
    campaign_1.impression_hours.create(start: "2000-01-01 18:00:00", end: "2000-01-01 19:00:00", imp: 200, day: "everyday")
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "Budget campaigns do not fit" do
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 10, state: true, status: 0, budget: 800)
    campaign_2 = create(:campaign, name: "2 Per Minute", project: @project, classification: 1, provider_campaign: true, duration: 10, state: true, status: 0, imp: 5, minutes: 1)
    campaign_1.board_campaigns.first.update(status: "approved")
    campaign_2.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
  ...
  test "First day test" do
    ...
    campaign_1 = create(:campaign, name: "1 Budget", project: @project, classification: 0, provider_campaign: true, duration: 20, state: true, status: 0, budget: 700)
    campaign_1.board_campaigns.first.update(status: "approved")
    err = @board.update_ads_rotation(force_generate = true)
    ...
    [campaign_1.board_campaigns.first.remaining_impressions, Faker::Number.between(from: 10, to: 500)].min.times do
      Impression.create(campaign_id: campaign_1.id, board_id: @board.id, created_at: rand_time(start_time, end_time), api_token: @board.api_token, duration: campaign_1.duration)
      count += 1
    end
    ...
    assert_equal (campaign_1.budget_per_bilbo/(@board.get_cycle_price(campaign_1) * campaign_1.duration/@board.duration)).to_i, campaign_1.remaining_impressions(@board) + count
  end
  ...
  test "Second Day test" do
    ...
    campaign_1.board_campaigns.first.remaining_impressions.times do
      Impression.create(campaign_id: campaign_1.id, board_id: @board.id, created_at: rand_time(start_time-1.day, end_time-1.day), api_token: @board.api_token, duration: campaign_1.duration)
    end
    campaign_1.board_campaigns.update(update_remaining_impressions: true)
    assert_equal (campaign_1.budget_per_bilbo/(@board.get_cycle_price(campaign_1) * campaign_1.duration/@board.duration)).to_i, campaign_1.remaining_impressions(@board)
  end
