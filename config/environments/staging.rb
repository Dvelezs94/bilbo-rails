Rails.application.configure do
  ...
  config.middleware.use(Rack::Tracker) do
    handler :facebook_pixel, { id: ENV.fetch('FACEBOOK_PIXEL_ID') {"123456789"} }
  end
  ...
  Rails.application.routes.default_url_options[:host] = "https://staging.app.bilbo.mx"
  config.action_mailer.default_url_options = { host: "https://staging.app.bilbo.mx" }
end
